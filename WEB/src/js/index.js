var mods = [
  ...
  'tabs', 'menu', 'route', 'utils', 'component', 'kit', 'echarts','form'
];
    ...
    routeInit: function(config) {
      ...
      var routeOpts = {
        routes: [{
          ...
          path:'/data/check',
          component:'views/data/check.html',
          name:'数据校验'
        },{
          path:'/data/import',
          component:'views/data/import.html',
          name:'数据导入'
        },{
          path:'/data/show',
